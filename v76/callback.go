...
type CallbackHandlerV76 struct {
	events chan gomultistripe.CallbackEvent
	mu     sync.Once
}

func NewCallbackHandlerV76() *CallbackHandlerV76 {
	return &CallbackHandlerV76{
		events: make(chan gomultistripe.CallbackEvent, 100),
	}
}

func (h *CallbackHandlerV76) Events() <-chan gomultistripe.CallbackEvent {
	return h.events
}

func (h *CallbackHandlerV76) HandleWebhook(payload []byte, sigHeader string) error {
