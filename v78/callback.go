...
type CallbackHandlerV78 struct {
	events chan gomultistripe.CallbackEvent
	mu     sync.Once
}

func NewCallbackHandlerV78() *CallbackHandlerV78 {
	return &CallbackHandlerV78{
		events: make(chan gomultistripe.CallbackEvent, 100),
	}
}

func (h *CallbackHandlerV78) Events() <-chan gomultistripe.CallbackEvent {
	return h.events
}

func (h *CallbackHandlerV78) HandleWebhook(payload []byte, sigHeader string) error {
