...
type CallbackHandlerV81 struct {
	events chan gomultistripe.CallbackEvent
	mu     sync.Once
}

func NewCallbackHandlerV81() *CallbackHandlerV81 {
	return &CallbackHandlerV81{
		events: make(chan gomultistripe.CallbackEvent, 100),
	}
}

func (h *CallbackHandlerV81) Events() <-chan gomultistripe.CallbackEvent {
	return h.events
}

func (h *CallbackHandlerV81) HandleWebhook(payload []byte, sigHeader string) error {
