...
type CallbackHandlerV82 struct {
	events chan gomultistripe.CallbackEvent
	mu     sync.Once
}

func NewCallbackHandlerV82() *CallbackHandlerV82 {
	return &CallbackHandlerV82{
		events: make(chan gomultistripe.CallbackEvent, 100),
	}
}

func (h *CallbackHandlerV82) Events() <-chan gomultistripe.CallbackEvent {
	return h.events
}

func (h *CallbackHandlerV82) HandleWebhook(payload []byte, sigHeader string) error {
